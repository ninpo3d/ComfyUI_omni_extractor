...
[![DOI](https://img.shields.io/badge/DOI-10.5281%2Fzenodo.18236538-blue.svg)](https://doi.org/10.5281/zenodo.18236538)
...
* a **compact color atlas (ramp)** that stores *appearance* (what things look like)

At runtime, these two parts are recombined on the GPU to reconstruct the original image with minimal memory cost. All heavy processing happens offline.

> **Important clarification:** Omni-Extractor does **not** use neural networks, machine learning, or generative AI.
> The system relies entirely on deterministic signal processing (clustering, sorting, and GPU texture sampling).
> No inference, training, or probabilistic models are involved at runtime.
